...
import type { CardiologyMedicationOrder } from '../../types';
import { CardiologyNav } from './CardiologyNav';

export function CardiologyMedicationsPage() {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ['cardiology-medications', page, search, isActive],
        queryFn: () =>
    ...
    const deleteMutation = useMutation({
        mutationFn: (id: string) => cardiologyMedicationService.deleteOrder(id),
        onSuccess: () => {
    ...
    const handleDelete = (order: CardiologyMedicationOrder) => {
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Cardiology Medications</h1>
                    <p className="text-gray-500 mt-1">Monitor cardiology medication regimens.</p>
                </div>
                <Link to="/cardiology/medications/new">
                    <Button>
                                    ...
                                    <tr key={order.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                <Link to={`/cardiology/medications/${order.id}/edit`}>
